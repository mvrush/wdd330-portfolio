// NEXT LINE ADDED DURING TEAM WORK it impots everything as 'model' from our 'model.js'
...
export default class Hikes {
  ...
  showHikeList() {
    this.parentElement.innerHTML = ''; // this line clears everything out of the <ul> tag
  ...
  // This function builds our back button that appears on the single hike page.
  buildBackButton() {
    ...
    backButton.classList.add('hidden'); // This hidden class hides it from view on the all hikes page
