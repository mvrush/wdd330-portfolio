...
export default class ToDos {
  constructor(listElement, key) {
    ...
    this.listToDos();
    // why bind here? Because it binds the 'X' button with id="removeToDo" the the 'removeToDo' function.
    bindTouch("#removeToDo", this.newToDo.bind(this));
    this.listToDos();
  }
